...
it('searches only published public resources', function (): void {
    ...
    $type = OpportunityType::query()->create(['key' => 'funding', 'name' => 'Funding']);
    ...
    Opportunity::query()->create(['opportunity_type_id' => $type->id, 'title' => 'Sales Opportunity', 'description' => 'Sales', 'is_published' => true]);
    Opportunity::query()->create(['opportunity_type_id' => $type->id, 'title' => 'Hidden Opportunity', 'description' => 'Sales', 'is_published' => false]);
