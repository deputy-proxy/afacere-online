<div class="flex w-full flex-col gap-8 py-6">
    ...
    <section class="space-y-3">
        ...
        @empty
            <div class="rounded-xl border border-dashed border-zinc-300 p-6 text-center dark:border-zinc-700">{{ __('You are all caught up.') }}</div>
        @endforelse
    </section>

    <section class="space-y-3">
        <h2 class="text-xl font-semibold">{{ __('Recent activity') }}</h2>
