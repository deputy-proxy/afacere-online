<section class="space-y-6">
    <div>
        <h1 class="text-2xl font-semibold">{{ __('Data & privacy') }}</h1>
        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">{{ __('Export your account data or request deletion. Server-side lifecycle rules remain authoritative.') }}</p>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <section class="rounded-xl border p-5">
            <h2 class="font-semibold">{{ __('Export your data') }}</h2>
        ...
        <section class="rounded-xl border border-red-200 p-5 dark:border-red-900">
            <h2 class="font-semibold">{{ __('Delete your account data') }}</h2>
            ...
            @if ($this->deletionRequest)
                <div class="mt-4 rounded-lg bg-zinc-50 p-4 text-sm dark:bg-zinc-800">
