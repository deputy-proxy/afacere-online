...
final class DomainEventService
{
    ...
    public function record(string $type, ?User $actor = null, ?Business $business = null, ?Model $subject = null, array $payload = []): DomainEvent
    {
    ...
    /** @param array<string, mixed> $payload */
    public function transaction(string $type, ?User $actor, ?Business $business, ?Model $subject, array $payload = []): DomainEvent
    {
