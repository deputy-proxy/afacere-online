...
class Action extends Model
{
    ...
    protected function casts(): array { return ['status' => ActionStatus::class, 'accepted_at' => 'datetime', 'started_at' => 'datetime', 'completed_at' => 'datetime']; }
    /** @return BelongsTo<ActionPlan, $this> */
    public function plan(): BelongsTo { return $this->belongsTo(ActionPlan::class, 'action_plan_id'); }
